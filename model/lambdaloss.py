# https://github.com/allegro/allRank/blob/c88475661cb72db292d13283fdbc4f2ae6498ee4/allrank/models/losses/lambdaLoss.py
import torch
...
def lambdaLoss(
    ...
    :param weighing_scheme: a string corresponding to a name of one of the weighing schemes, default: None
